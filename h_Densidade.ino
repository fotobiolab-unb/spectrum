...
/*#*/DensidadeAtual = (70.45496*exp(-1.0*Vis_IR/355.07195) + 7.83826*exp(-1.0*Vis_IR/5570.96923) - 0.49460)*1E6;

/*
    if (ID == 1) DensidadeAtual = 1E6;
    if (ID == 2) DensidadeAtual = 1E6;
    if (ID == 3) DensidadeAtual = 1E6;
    if (ID == 4) DensidadeAtual = 1E6;
    if (ID == 5) DensidadeAtual = 1E6;
    if (ID == 6) DensidadeAtual = 1E6;
    if (ID == 7) DensidadeAtual = 1E6;
*/
  }
}
